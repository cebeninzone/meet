...
class AuthServices {
  ...
  //Ad
  static Future<Ad> getAd() async {
    return await Ad.fromRawJson(prefs.getString(AppStrings.appAd));
  }
  ...
  static Future<User> getCurrentUser({bool force = false}) async {
    if (currentUser == null || force) {
      final userStringObject = await prefs.getString(AppStrings.userKey);
