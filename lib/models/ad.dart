...
class AdData {
  ...
  factory AdData.fromJson(Map<String, dynamic> json) => AdData(
        ...
        bannerAdId: json["banner_ad_id"] == null ? null : json["banner_ad_id"],
        interstitialAdId: json["interstitial_ad_id"],
        adEnable: json["ad_enable"] == null ? null : json["ad_enable"],
      );

  Map<String, dynamic> toJson() => {
        "app_id": appId == null ? null : appId,
        "banner_ad_id": bannerAdId == null ? null : bannerAdId,
        "interstitial_ad_id": interstitialAdId,
        "ad_enable": adEnable == null ? null : adEnable,
      };
}
